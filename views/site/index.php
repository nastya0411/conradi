...
<div class="site-index">
    ...
    <div class="container-fluid p-0">
        <div class="fullscreen-hero">
            ...
            <!-- Контент -->
            <div class="hero-container bg-white bg-opacity-10">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="review-card">
                    <div class="review-header">
                        <img src="/web/img/6.jpg" class="review-avatar" alt="Михаил">
                        <div class="review-info">
                            <h4>Егор</h4>
                    ...
                    <p class="review-text">
                        Купил маме цветы на 8 Марта. В "Конради" помогли выбрать свежий и стильный букет.
                        Доставили точно в срок, цветы были в идеальном состоянии. Мама очень обрадовалась,
                        теперь знаю, где буду заказывать цветы для близких.
                    </p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="review-card">
                    <div class="review-header">
                        <img src="/web/img/7.png" class="review-avatar" alt="Елена">
                        <div class="review-info">
                            <h4>Елена</h4>
